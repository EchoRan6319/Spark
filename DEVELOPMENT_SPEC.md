...
### 4.2 全局主题 (iOS 26 Liquid)
- **设计风格**: 采用 iOS 26 “液态玻璃”设计语言，强调高折射、流体质感与极致的精致感。
- **字体**: 使用系统默认字体，确保跨平台的一致性与原生感。
- **模式支持**: 全面适配 **Light (Crystal)** 与 **Dark (Obsidian)** 模式。
- **基础色彩**:
    - **Primary**: `#007AFF` (Apple Blue)。
    - **Light Mode**: 纯白/浅灰背景 (`#FFFFFF` / `#F2F2F7`)，搭配高亮液态玻璃。
    - **Dark Mode**: 纯黑/深灰背景 (`#000000` / `#1C1C1E`)，搭配深邃液态玻璃。
- **液态玻璃规范**:
    - 维持 `liquid_glass_widgets` 的高品质设置。
    - 浅色模式：厚度 25，模糊 15，不透明度 0.12。
    - 深色模式：厚度 40，模糊 25，不透明度 0.18。
